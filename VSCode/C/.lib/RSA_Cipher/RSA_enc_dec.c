...
void RSA_Workmode(){
    ...
    FILE *recipient=fopen("./RSA_work_inf/Recip_inf.txt","w+");
    ...
    if(op2==1)
    {
        ...
        FILE *send=fopen("./RSA_work_inf/C_inf.txt","w+");
    ...
    else if(op2==2)
    {
        ...
        else
        {
            ...
            FILE *sender=fopen("./RSA_work_inf/Sender_inf.txt","w+");
    ...
    if(op==1)
    {
        ...
        FILE *public=fopen("./RSA_work_inf/public_key.pem","w+");
        ...
        FILE *private=fopen("./RSA_work_inf/private_key.pem","w+");
