...
int L[32],R[32],SK[16][48];
char tempM[20],tempK[20];

int main()
{
    int i, j, k;
    int n, ans;
    int M[64], Key[64], temp[32], out[64];
    char cipher[20];
    scanf("%d\n", &n);
    scanf("%s\n", tempM);
    scanf("%s", tempK);
